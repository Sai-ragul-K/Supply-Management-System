...
<body class="login-box">
	...
	<li>
		...
		<div class="input-box"> <input type="text" id="login:username" name="txtUsername" placeholder="Username" /> </div><br>
	</li>
	<li>
		<!-- <div class="label-block"> <label for="login:password">Password</label> </div> -->
		<div class="input-box"> <input type="password" id="login:password" name="txtPassword" placeholder="Password" /> </div><br>
	</li>
	<li>
		<!-- <div class="label-block"> <label for="login:type">Login Type</label> </div> -->
		<div class="input-box">
		<select class='select-box' name="login_type" id="login:type">
	...
	<li>
		<input type="submit" value="Sign In" class="submit_button" /> <span class="error_message"> <?php echo $loginErr; echo $reqErr; ?> </span>
	</li>
	</ul>
	</form>
	</div>
